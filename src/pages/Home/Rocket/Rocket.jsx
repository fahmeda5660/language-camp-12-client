  ...
  return (
    <div>
      <div className="md:flex lg:flex justify-center items-center gap-4 px-8">
        ...
        <button className=" w-full md:w-auto lg:w-auto mx-auto md:mx-0 lg:mx-0 px-16 py-6 text-white bg-purple-500 text-3xl font-semibold rounded-md mt-3 md:mt-0 lg:mt-0">
          Enroll Now
        </button>
      </div>
